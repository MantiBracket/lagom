#include <lagom/nccl227.h>
#include <lagom/tensor.h>
#include <lagom/utils.cuh>
#include <lagom/utils.h>
...
public:
  ...
  TVM_FFI_DECLARE_OBJECT_INFO_FINAL("lagom.NCCLWrapper", NCCLWrapper,
                                    tvm::ffi::Object);
