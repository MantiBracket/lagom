...
import torch
from lagom.core import Batch, get_global_ctx
from lagom.distributed import get_tp_info
from lagom.env import ENV
from lagom.utils import div_even, init_logger
...
if TYPE_CHECKING:
    ...
    from lagom.models import ModelConfig
