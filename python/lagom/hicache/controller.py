...
from lagom.core import get_global_ctx
from lagom.utils import init_logger

if TYPE_CHECKING:
    from lagom.kvcache import BaseCacheHandle, BasePrefixCache
    from lagom.kvcache.hiradix_cache import HiRadixPrefixCache
...
class HiCacheTransferMixin:
    ...
    def load_one(self, host_indices: torch.Tensor, cuda_indices: torch.Tensor, i: int) -> None:
        from lagom.kernel import transfer_hicache_one_layer
    ...
    def load_all(self, host_indices: torch.Tensor, cuda_indices: torch.Tensor) -> None:
        from lagom.kernel import transfer_hicache_all_layer
